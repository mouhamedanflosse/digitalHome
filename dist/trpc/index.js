...
exports.appRouter = (0, trpc_1.router)({
    ...
    getProducts: trpc_1.PublicProcedure.input(zod_1.z.object({
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, sort, limit, queryOptions, payload, parsedqueryOptions, page, _b, item, nextPage, hasNextPage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _b = _c.sent(), item = _b.docs, nextPage = _b.nextPage, hasNextPage = _b.hasNextPage;
                        return [2 /*return*/, {
                                item: item,
