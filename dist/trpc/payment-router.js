...
exports.paymentRouter = (0, trpc_1.router)({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        filteredProduct = products.filter(function (pr) { return Boolean(pr.priceID); });
                        return [4 /*yield*/, payload.create({
                                collection: "order",
                                data: {
                                    _isPaid: false,
                                    products: filteredProduct.map(function (item) { return item.id; }),
                                    user: user.id,
                                },
                            })];
                    case 3:
    ...
    getOrderStatus: trpc_1.privateProcedure.input(zod_1.z.object({ orderID: zod_1.z.string() })).query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
